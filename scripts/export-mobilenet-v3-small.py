#!/usr/bin/env python3
"""Export MobileNetV3Small as a TensorFlow SavedModel for KServe."""
...
DEFAULT_OUTPUT_DIR = "/pv/mobilenet-v3-small/1"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Download ImageNet MobileNetV3Small weights and export a SavedModel.",
    )
    parser.add_argument(
        "--output-dir",
...
def main() -> int:
    ...
    print(f"Exported MobileNetV3Small SavedModel to {output_dir}")
    return 0
